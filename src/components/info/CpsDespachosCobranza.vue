<template>
  <main>
    <app-despacho-cobranza _nghost-ng-c3492076768 ngh="0"><portada-component _ngcontent-ng-c3492076768
        title="DESPACHOS DE COBRANZA EXTERNOS" colortext="text-white" img="Despacho de cobranza"
        alt="cuatro personas sentadas tras su computadora" _nghost-ng-c3982346130 ngh="0">
        <header _ngcontent-ng-c3982346130><img _ngcontent-ng-c3982346130 src="/src/assets/Despacho de cobranza.webp"
            alt="cuatro personas sentadas tras su computadora">
          <div _ngcontent-ng-c3982346130 class="title-block">
            <h1 _ngcontent-ng-c3982346130 class="text-white">DESPACHOS DE COBRANZA EXTERNOS</h1><app-redes-sociales
      ...
      <section _ngcontent-ng-c3492076768 class="despacho-cobranza">
        <div _ngcontent-ng-c3492076768 class="container">
    ...
    </app-despacho-cobranza>
  </main>
</template>
<style lang="css" scoped>
.despacho-cobranza[_ngcontent-ng-c3492076768] {
  padding: 80px 0
}

.despacho-cobranza[_ngcontent-ng-c3492076768] .que-es[_ngcontent-ng-c3492076768] {
  margin-bottom: 50px
}

.despacho-cobranza[_ngcontent-ng-c3492076768] p[_ngcontent-ng-c3492076768] {
  font-size: 1.2rem
}
