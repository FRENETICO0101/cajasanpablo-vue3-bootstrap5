<template>
  <main>
    <app-profun _nghost-ng-c1010798289 ngh="0"><portada-component _ngcontent-ng-c1010798289
        title="Servicio de Apoyo Funerario" colortext="text-white" img="profun" alt="Hombre parado en las montañas"
        _nghost-ng-c3982346130 ngh="0">
        <header _ngcontent-ng-c3982346130>
          <img _ngcontent-ng-c3982346130 src="/src/assets/profun.webp" alt="Hombre parado en las montañas" />
          <div _ngcontent-ng-c3982346130 class="title-block">
            <h1 _ngcontent-ng-c3982346130 class="text-white">Servicio de Apoyo Funerario</h1>
      ...
      <section _ngcontent-ng-c1010798289 class="profun">
        <div _ngcontent-ng-c1010798289 class="container py-5">
