...
// Credit data for Consumo section
...
.card-credito-btn-simulador:hover {
  background-color: var(--color-secundario);
  color: white;
...
.accordion-button:focus {
  box-shadow: 0 0 0 0.25rem rgba(70, 162, 253, 0.25);
}
